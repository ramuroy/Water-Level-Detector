...
✅ Visual alert using an LED when water reaches a set level  
✅ Audible alert using a buzzer when water is about to overflow  
✅ Automatic reset when the water level drops  
